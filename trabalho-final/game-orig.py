...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.surf = pygame.Surface((5, 5)) #Define o retangulo que representa o player
        harry = pygame.image.load('hp.png')
        self.surf = harry
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.surf = pygame.Surface((10, 5)) #Definicao do retangulo
        asteroide = pygame.image.load('bludger.png')
        self.surf = asteroide
        ...
        self.speed = random.uniform(1, 1.2) #Sorteia sua velocidade, entre 1 e 15
